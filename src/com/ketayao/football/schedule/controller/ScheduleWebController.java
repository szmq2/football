...
public class ScheduleWebController {
	...
	public String list(Long isSchedule, ServletRequest request, Map<String, Object> map) {
		Specification<Schedule> specification = DynamicSpecifications.bySearchFilter(request, Schedule.class);
		List<Schedule> schedules = scheduleService.findByExample(specification, new Page());
